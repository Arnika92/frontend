...
const Sidebar = () => {
  ...
  return (
    <>
      <div class="sticky top-0 h-[100vh] flex pl-2" >
        <div className={`flex flex-col justify-between h-full ${activeTab==="Search" ? "px-2" :"px-10"}`}>
          <div>
            {activeTab !== "Search" && <div className="pt- top-0">
             
                <div className="top-10 h-10 w-10 hidden md:block ">
                  <img className="h-10 w-10" src="Logo.png" alt="logo" />
                </div>
                {/* <div className="underline text-white text-left font-sans text-3xl pl-20 h-10 w-10">
                  <b>PICPOP</b>
                </div> */}
            ...
            <div className="mt-10 ">
              {menu.map((item) => (
                <div
                  ...
                  className="flex items-center cursor-pointer text-lg p-1 text-white rounded-lg dark:text-yellow hover:bg-yellow-100 dark:hover:bg-yellow-700 hover:text-black group">
          ...
          <div className="pb-10 pl-1 flex  items-center text-lg p-2 rounded-lg dark:text-yellow dark:hover:bg-yellow-700 hover:text-black group">
            <IoReorderThreeOutline className="text-2xl text-white" />
            {activeTab !== "Search" && <p className="ml-5 text-white">More</p>}
          </div>
        </div>
